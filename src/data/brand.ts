/** Brand foundation data for KitchenBots */

export const BRAND = {
    name: 'KitchenBots India',
    tagline: 'Precision Meets Fire.',
    shortTagline: 'Engineer Your Flame.',
    category: 'Premium Outdoor Cooking Systems',
    ...
    valuePropositions: [
        {
            ...
            description: 'High-grade mild steel construction with heat-resistant coatings rated to 1000°C+. No warping, no peeling, no compromise.',
        },
        {
            title: 'Engineered Thermal Performance',
            description: 'Precision combustion chambers and optimised airflow design deliver faster heat-up times and fuel savings of up to 40%.',
        },
        {
        ...
        },
        {
            ...
            description: 'From home balconies to restaurant kitchens, our systems scale. Wholesale pricing available for bulk and trade orders.',
        },
        {
    ...
    stats: [
        { value: '10,000+', label: 'Grills Delivered' },
        { value: '15+', label: 'Engineered Models' },
        { value: '10 Years', label: 'Manufacturing Experience' },
        { value: '₹3K–₹20K', label: 'Price Range' },
    ],

    warrantyHighlight: 'Every KitchenBots product ships with a 12-month manufacturing warranty. Structural warranties up to 10 years on select models.',

    certifications: [
        'ISI Mark Qualified Steel',
        'Heat-Resistance Tested: 1000°C',
        'Made in India \'Atmanirbhar\' Certified',
